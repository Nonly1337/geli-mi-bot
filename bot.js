...
.then(channel =>
 channel.setParent(message.guild.channels.find(channel => channel.name === "|▬▬|IMPORTANT CHANNELS|▬▬|")));
 message.guild.createChannel('「🚪」welcome-bye', 'text', [{
  id: message.guild.id,
  deny: ['SEND_MESSAGES']
}])
.then(channel =>
       channel.setParent(message.guild.channels.find(channel => channel.name === "|▬▬|IMPORTANT CHANNELS|▬▬|")));
       message.guild.createChannel('「✅」counter', 'text', [{
        id: message.guild.id,
        deny: ['SEND_MESSAGES']
      }])
.then(channel =>
            ...
            .then(channel => channel.setParent(message.guild.channels.find(channel => channel.name === "|▬▬|IMPORTANT CHANNELS|▬▬|")));
...
.then(channel =>
 channel.setParent(message.guild.channels.find(channel => channel.name === "|▬▬|IMPORTANT CHANNELS|▬▬|")));
      ...
      message.guild.createChannel(`「💡」complaints-and-suggestions`, 'text')
     .then(channel =>
      channel.setParent(message.guild.channels.find(channel => channel.name === "|▬▬|General Channels|▬▬|")));
     message.guild.createChannel(`「👥」minecraft-premium`, 'text')
     .then(channel =>
            channel.setParent(message.guild.channels.find(channel => channel.name === "|▬▬|General Channels|▬▬|")));
     message.guild.createChannel(`「📷」arts`, 'text')
     .then(channel =>
                  channel.setParent(message.guild.channels.find(channel => channel.name === "|▬▬|General Channels|▬▬|")));
     message.guild.createChannel(`「🤖」bot-cmds`, 'text')
     .then(channel =>
                  channel.setParent(message.guild.channels.find(channel => channel.name === "|▬▬|General Channels|▬▬|")));
     message.guild.createChannel(`「💬」chats`, 'text')
     .then(channel =>
      channel.setParent(message.guild.channels.find(channel => channel.name === "|▬▬|General Channels|▬▬|")));

      message.guild.createChannel(`🏆》Owner Room`, "voice")
      .then(channel =>
        channel.setParent(message.guild.channels.find(channel => channel.name === "|▬▬|Voice Channels|▬▬|")))
      .then(c => {
    ...
    message.guild.createChannel('|▬▬|Voice Channels|▬▬|', 'category', [{
      id: message.guild.id,
    }]);
...
message.guild.createChannel('|▬▬|GAME CHANNELS|▬▬|', 'category', [{
  id: message.guild.id,
}]);

message.guild.createChannel(`🎮》LOL`, 'voice')
.then(channel =>
 channel.setParent(message.guild.channels.find(channel => channel.name === "|▬▬|GAME CHANNELS|▬▬|")))
    ...
    .then(channel =>
     ...
     .then(channel =>
      ...
      message.guild.createRole({
       ...
       message.channel.send("My Job Done Sir!")
